...
export const RegistryTypes = {
  ...
  SIGN_REQUEST: new RegistryType("sign-request", 401),
  SIGNATURE: new RegistryType("signature", 402),
  BATCH_SIGN_REQUEST: new RegistryType("batch-sign-request", 40404),
  BATCH_SIGNATURE: new RegistryType("batch-signature", 40405),
};